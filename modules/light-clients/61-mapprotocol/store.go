...
// This is useful when validating whether a packet has reached the time specified delay period in the mapprotocol client's
...
// GetProcessedTime gets the time (in nanoseconds) at which this chain received and processed a mapprotocol header.
...
// This is useful when validating whether a packet has reached the specified block delay period in the mapprotocol client's
// verification functions
...
// GetProcessedHeight gets the height at which this chain received and processed a mapprotocol header.
...
// as this is internal mapprotocol light client logic.
